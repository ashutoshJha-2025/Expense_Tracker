...
const QuickAccess = () => {
    return (
        <>
            <div className='w-full h-full bg-[#1B1B1B] rounded-2xl border border-slate-800 flex flex-col items-start'>
                <div className="p-2">
                ...
                <div className="w-full h-[75%] flex justify-start items-center ml-5">
                    ...
                    <Link to='/add-expense' className="bg-[#28282A] w-auto px-4 h-18 flex justify-center items-center gap-2 rounded-2xl cursor-pointer">
